    ...
    return (
        <footer className="bg-black  w-full flex flex-col text-center space-y-8 p-2 md:p-2 lg:p-2 lg:border lg:border-zinc-900 md:border md:border-zinc-900">
            ...
            <div className="text-white">
                <h2 className="text-xl md:text-xl font-bold mb-1 tracking-wide mb-3">Join our waitlist to be the first to hear when our platform goes live!</h2>
            ...
            <div className="text-white space-y-2" style={{ marginTop: "5px" }}>
                <p className="text-sm md:text-base my-5 font-bold text-gray-300">Check us out on social media!</p>
